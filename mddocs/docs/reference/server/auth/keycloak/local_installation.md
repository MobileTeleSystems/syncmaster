...
Go to [Keycloak admin page](http://localhost:8080/admin) and sign in using login: `admin`, password: `admin` (by default):
...
Now you can use create users in this realm, check [Keycloak documentation](https://www.keycloak.org/docs/latest/server_admin/#assembly-managing-users_server_administration_guide) on how to manage users creation.
