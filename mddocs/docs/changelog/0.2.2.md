...
- Call `kinit` before starting Spark session connecting to `Hive` cluster. ([#225](https://github.com/MTSWebServices/syncmaster/issues/225))
- Fix `HDFS` connection was trying to use anonymous auth instead of user/password. ([#225](https://github.com/MTSWebServices/syncmaster/issues/225))
