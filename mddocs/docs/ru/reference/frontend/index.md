...
SyncMaster предоставляет [Фронтенд (UI)](https://github.com/MobileTeleSystems/syncmaster-ui) на основе [React](https://react.dev/),
дающий пользователям возможность создавать, обновлять, удалять сущности.
...
- После запуска и готовности фронтенда, откройте [http://localhost:3000](http://localhost:3000).
