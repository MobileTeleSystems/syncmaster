# Local installation and testing { #local_installation }
...
At first, you have to go to [http://localhost:8080/admin](http://localhost:8080/admin) and login via login: `admin`, password: `admin` (by default) to create realms.
...
Now you can use create users in this realms, check [keycloak documentation](https://www.keycloak.org/docs/latest/server_admin/#assembly-managing-users_server_administration_guide) on how to manage users creation.
