...
async def create_transfer(
    ...
    async with unit_of_work:
        transfer = await unit_of_work.transfer.create(
            ...
            source_params=transfer_data.source_params.model_dump(mode="json"),
            target_params=transfer_data.target_params.model_dump(mode="json"),
            strategy_params=transfer_data.strategy_params.model_dump(mode="json"),
            transformations=[tr.model_dump(mode="json") for tr in transfer_data.transformations],
            resources=transfer_data.resources.model_dump(mode="json"),
